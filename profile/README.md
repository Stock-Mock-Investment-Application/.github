...
<table>
  ...
  <tr>
    <td>정소영</td>
    <td>6인팀 프로젝트를 진행하면서, 저에게 협업과 소통 능력이 부족함을 깨닫게 되었습니다. 처음 팀을 만났을 때, ice breaking으로 이야기를 많이 나누어야 한다는 것. 그 중에서도 소통 능력에 대해 배우고 싶은 팀원과 만나게 되어 감사합니다. 또, Git을 능숙하게 다룰 줄 알아야 다른 팀원들의 작업에 영향을 주지 않다는 것과 build 에러를 꼭 확인하고, 미리 체킹 후 merge를 해야한다는 것을 경험을 통해 배우게 되었습니다.<br/> 개발 분야에 있어서는 최신 기술인 React를 활용해서 프로젝트를 진행할 수 있어서 좋았고, API 명세서에 따라 DB의 자료를 불러오고 표출시키는 과정에서 배울점이 많았습니다. 또한, 개인적으로 웹개발을 할 때는 주로 cloudtype이나 dothome과 같은 호스팅 서비스를 사용했는데, 이번에 AWS나 docker, Jenkins를 활용해서 배포하는 방법에 대해 공부해보고 싶다는 생각이 들었습니다.(같은팀 백엔드분께서 문서정리를 잘해주셔서 감사)<br/>AI를 활용한 개발도 무척 재미있었습니다. 예전에는 주로 CNN이나 CGCNN 같은 과학 분야에 특화된 모델을 많이 다루었는데, 이번에는 개발자의 입장에서 Text to image 모델(SDXL)이나 LSTM, DPO와 같은 조금 더 대중적인 목표를 가진 모델에 대해 공부하고 활용해볼 수 있어서 유익했던 것 같습니다. SSAFY 덕분에, 개발자로서도 개인으로서도 크게 성장하고 있음을 느끼고 있습니다. 감사합니다 </td>
  </tr>
  <tr>
    <td>김연지</td>
    <td>느낀점</td>
